         ...
         <div class="col-md-10">
            <div class="panel panel-default card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark"><u>Modifier entreprise</u></h6>
                    </div>
                                    ...
                                    <form>
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="designEntreprise" class="form-control" value="{{ $entreprise->designEntreprise }}" required>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="icon-user"></i></div>
                                                <input type="adress" name="localEntreprise" class="form-control" value="{{ $entreprise->localEntreprise }}" required>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="icon-user"></i></div>
                                                <input type="text" name="nccEntreprise" class="form-control" value="{{ $entreprise->nccEntreprise }}" required>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="icon-user"></i></div>
                                                <input type="email" name="emailEntreprise" class="form-control" value="{{ $entreprise->emailEntreprise }}" required>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="icon-user"></i></div>
                                                <input type="text" name="telEntreprise1" class="form-control" value="{{ $entreprise->telEntreprise1 }}" required>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="icon-user"></i></div>
                                                <input type="text" name="telEntreprise2" class="form-control" value="{{ $entreprise->telEntreprise2 }}" required>
                                            </div>
                                        </div>
