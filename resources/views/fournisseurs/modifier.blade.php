        ...
        <div class="col-md-8">
            <div class="panel panel-default card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark"><u>Modifier Fournisseur</u></h6>
                    </div>
                                    ...
                                    <form>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="nom" class="form-control" value="{{ $fournisseur->nom  }}" required required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="icon-user"></i></div>
                                                <input type="text" name="prenom"  class="form-control" id="exampleInputuname_1" value="{{ $fournisseur->prenom  }}" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="icon-user"></i></div>
                                                <input type="numeric" name="telFournisseur"  class="form-control" id="exampleInputuname_1" value="{{ $fournisseur->telFournisseur  }}" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="icon-user"></i></div>
                                                <input type="adresse" name="addresseFournisseur"  class="form-control" id="exampleInputuname_1"  value="{{ $fournisseur->addresseFournisseur  }}" required>
                                            </div>
                                        </div>
