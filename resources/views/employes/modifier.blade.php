        ...
        <div class="col-md-10">
            <div class="panel panel-default card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark"><u>Modifier employé</u></h6>
                    </div>
                                ...
                                <div class="form-wrap">
                                    <form>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="icon-user"></i></div>
                                                <input type="text" name="prenom"  class="form-control" id="exampleInputuname_1" value="{{ $employe->prenom }}" required>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="icon-user"></i></div>
                                                <input type="text" name="telEmploye"  class="form-control" id="exampleInputuname_1" value="{{ $employe->telEmploye  }}" required>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="icon-user"></i></div>
                                                <input type="text" name="cniEmploye"  class="form-control" id="exampleInputuname_1" value="{{ $employe->cniEmploye }}" required>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="email" name="login"  class="form-control" id="exampleInputEmail_1" value="{{ $employe->login }}" required>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="password" name="password"  class="form-control" id="exampleInputpwd_1" value="{{ $employe->password }}" required>
                                            </div>
                                        </div>
