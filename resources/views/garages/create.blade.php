                                ...
                                <div class="form-wrap">
                                    <form>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="icon-user"></i></div>
                                                <input type="text" name="numeroGarage" class="form-control"  placeholder="+2250000000000" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="adress" name="adresseGarage" class="form-control" placeholder="adresse" required>
                                            </div>
                                        </div>
